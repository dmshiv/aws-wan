...
variable "gives_cidr_to_public_subnets" {
  ...
  type        = list(string)
  default     = ["41.0.1.0/24", "41.0.2.0/24", "41.0.3.0/24"]
}
...
variable "gives_cidr_to_private_subnets" {
  ...
  type        = list(string)
  default     = ["41.0.4.0/24", "41.0.5.0/24", "41.0.6.0/24"]
}
...
variable "availability_zones" {
  ...
  type        = list(string)
  default     = ["eu-north-1a", "eu-north-1b", "eu-north-1c"] # Stockholm region AZs
}
